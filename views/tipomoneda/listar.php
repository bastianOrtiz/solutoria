        ...
        <section class="content">                
             <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="tabla_tipomoneda" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th> ID </th>
                        <th>Nombre</th>
                    ...
                    <tbody>
                        <?php foreach( $registros as $reg ){ ?>
                            <tr>
                                ...
                                <td> <?php echo excerpt($reg['descripcion'],20) ?> </td>
            ...
            $.ajax({
				...
				success: function (json) {
				    if(json.status == 'success'){
                        ...
                        html_iterante = '<div class="col-md-5">';
                        ...
                        html_iterante += '<div class="col-md-7">';
                        ...
                        html_iterante += '      <th>Valor</th>';
                        html_iterante += '      <th>Mes</th>';
                        html_iterante += '      <th style="width: 40px">Año</th>';
                        html_iterante += '    </tr>';    
                        
                        if( json.tipomonedavalores != 'vacio' ){                    
                            var j = 1;
                            $.each(json.tipomonedavalores, function(k,v){
                                html_iterante += '<tr>';
                        ...
                        $(".modal .btn.btn-info").attr('href','<?php echo BASE_URL ?>/tipomonedavalor/ingresar/' + regid);
