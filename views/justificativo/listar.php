      ...
      <div class="content-wrapper">
        ...
        <section class="content">                
             <div class="box">
                ...
                <div class="box-body">
                  <table id="tabla_justificativo" class="table table-bordered table-striped table-responsive">
                    <thead>
                      <tr>
                        <th> ID </th>
                        <th>Nombre</th>                        
                    ...
                    <tbody>
                        <?php foreach( $registros as $reg ){ ?>
                            <tr>
                                ...
                                <td> <?php echo getTipoJustificativo($reg['tipo']) ?> </td>                                                                
                                <td>                                      
