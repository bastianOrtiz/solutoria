        ...
        <section class="content">                
             <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="tabla_afp" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th> ID </th>
                        <th>Nombre</th>
            ...
            $.ajax({
				...
				success: function (json) {		
				    if(json.status == 'success'){				       
                        ...
                        if( json.afpvalores != 'vacio' ){                    
                            var j = 1;
                            $.each(json.afpvalores, function(k,v){
                                html_iterante += '<tr>';
                        ...
                        $(".modal .btn.btn-info").attr('href','<?php echo BASE_URL ?>/afpvalor/ingresar/' + regid);
