            ...
            $.ajax({
				...
				success: function (json) {
				    ...
				    if(json.status == 'success'){
                        ...
                        ht2 = '<div class="_contenedor" style="height:auto"><span class="_label" style="height:auto">Empresas</span><span class="_input" style="height:auto">';
                        $.each(json.empresas, function(k,v) {
                            ht2 += ' &bull; ' + v.Nombre + '<br />';    
                        })              
                        ht2 += '</span></div>';
                        $(".modal .modal-body").append(ht2);
