...
#table-previred  .form-control:focus{
    background: #feffe4;
    border: 2px solid #e4bc2a;
}
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <?php if( $revisor ):  ?>
                <form method="post" action="" id="the_form" style="overflow: hidden;">
                    <div class="box box-primary">
                        <div class="box-body">
                            
                            <div class="alerta bg-success">
                            ...
                            <table class="table table-bordered table-hover" id="table-previred">
                                ...
                                <tbody>
                                    <?php 
                                    $i = 1;
                                    foreach ($revisor as $key => $item) : 
                                    $value = $item['data'];
                                    ?>
                                    <tr class="row-dato" data-linea="<?php echo $item['linea']; ?>" data-rut="<?php echo substr($value, 0, 11); ?>-<?php echo substr($value, 11, 1); ?>">
                                        <td> 
                                        ...
                                        <td> <input type="text" name="codigo_de_la_afp[]" value="<?php echo substr($value, 505,2); // Código_de_la_AFP ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="monto_capitalizacion_voluntaria[]" value="<?php echo substr($value, 507,8); // Monto_Capitalización_Voluntaria ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="monto_ahorro_voluntario[]" value="<?php echo substr($value, 515,8); // Monto_Ahorro_Voluntario ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="numero_de_periodos_de_cotizacion[]" value="<?php echo substr($value, 523,2); // Número_de_períodos_de_cotización ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_ex_caja_regimen[]" value="<?php echo substr($value, 525,4); // Código_Ex-Caja_Régimen ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="tasa_cotizacion_ex_cajas_de_prevision[]" value="<?php echo substr($value, 529,5); // Tasa_Cotización_Ex-Cajas_de_Previsión ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imponible_ips[]" value="<?php echo substr($value, 534,8); // Renta_Imponible_IPS ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_obligatoria_ips[]" value="<?php echo substr($value, 542,8); // Cotización_Obligatoria_IPS ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imponible_desahucio[]" value="<?php echo substr($value, 550,8); // Renta_Imponible_Desahucio ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_ex_caja_regimen_desahucio[]" value="<?php echo substr($value, 558,4); // Código_Ex-Caja_Régimen_Desahucio ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="tasa_cotizac_desahucio_ex_cajas_prevision[]" value="<?php echo substr($value, 562,5); // Tasa_Cotizac_Desahucio_Ex-Cajas_Previsión ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_desahucio[]" value="<?php echo substr($value, 567,8); // Cotización_Desahucio ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_fonasa[]" value="<?php echo substr($value, 575,8); // Cotización_Fonasa ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_acc__trabajo_isl[]" value="<?php echo substr($value, 583,8); // Cotización_Acc._Trabajo_(ISL) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="bonificacion_ley_15_386[]" value="<?php echo substr($value, 591,8); // Bonificación_Ley_15.386 ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="descuento_por_cargas_familiares_isl[]" value="<?php echo substr($value, 599,8); // Descuento_por_cargas_familiares_(ISL) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="bonos_de_gobierno[]" value="<?php echo substr($value, 607,8); // Bonos_de_Gobierno ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_institucion_de_salud[]" value="<?php echo substr($value, 615,2); // Código_Institución_de_Salud ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="numero_de_fun[]" value="<?php echo substr($value, 617,16); // Número_de_FUN ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imponible_isapre[]" value="<?php echo substr($value, 633,8); // Renta_Imponible_Isapre ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="moneda_del_plan_pactado_isapre[]" value="<?php echo substr($value, 641,1); // Moneda_del_plan_pactado_Isapre ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_pactada[]" value="<?php echo substr($value, 642,8); // Cotización_Pactada ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_obligatoria_isapre[]" value="<?php echo substr($value, 650,8); // Cotización_Obligatoria_Isapre ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_adicional_voluntaria[]" value="<?php echo substr($value, 658,8); // Cotización_Adicional_Voluntaria ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="monto_ges_futuro[]" value="<?php echo substr($value, 666,8); // Monto_GES_(Futuro) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_ccaf[]" value="<?php echo substr($value, 674,2); // Código_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imponible_ccaf[]" value="<?php echo substr($value, 676,8); // Renta_Imponible_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="creditos_personales_ccaf[]" value="<?php echo substr($value, 684,8); // Créditos_Personales_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="dscto_dental_ccaf[]" value="<?php echo substr($value, 692,8); // Dscto_Dental_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="dsctos_por_leasing[]" value="<?php echo substr($value, 700,8); // Dsctos_por_Leasing ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="dsctos_por_seguro_de_vida_ccaf[]" value="<?php echo substr($value, 708,8); // Dsctos_por_seguro_de_vida_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="otros_descuentos_ccaf[]" value="<?php echo substr($value, 716,8); // Otros_descuentos_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizac_a_ccaf_no_afiliados_isapres[]" value="<?php echo substr($value, 724,8); // Cotizac_a_CCAF_no_afiliados_Isapres ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="descuento_cargas_familiares_ccaf[]" value="<?php echo substr($value, 732,8); // Descuento_Cargas_Familiares_CCAF ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="otros_descuentos_ccaf_1_futuro[]" value="<?php echo substr($value, 740,8); // Otros_descuentos_CCAF_1_(Futuro) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="otros_descuentos_ccaf_2_futuro[]" value="<?php echo substr($value, 748,8); // Otros_descuentos_CCAF_2_(Futuro) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="bonos_gobierno_futuro[]" value="<?php echo substr($value, 756,8); // Bonos_Gobierno_(Futuro) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_de_sucursal_futuro[]" value="<?php echo substr($value, 764,20); // Código_de_Sucursal_(Futuro) ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="codigo_mutualidad[]" value="<?php echo substr($value, 784,2); // Código_Mutualidad ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imponible_mutual[]" value="<?php echo substr($value, 786,8); // Renta_Imponible_Mutual ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="cotizacion_mutual[]" value="<?php echo substr($value, 794,8); // Cotización_MUTUAL ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="sucursal_para_pago_mutual[]" value="<?php echo substr($value, 802,3); // Sucursal_para_pago_Mutual ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="renta_imp_seguro_cesantia[]" value="<?php echo substr($value, 805,8); // Renta_Imp_Seguro_Cesantía ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="aporte_trabajador_seguro_cesantia[]" value="<?php echo substr($value, 813,8); // Aporte_Trabajador_Seguro_Cesantía ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="aporte_empleador_seguro_cesantia[]" value="<?php echo substr($value, 821,8); // Aporte_Empleador_Seguro_Cesantía ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="rut_pagadora_subsidio[]" value="<?php echo substr($value, 829,11); // Rut_Pagadora_Subsidio ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="dv_pagadora_subsidio[]" value="<?php echo substr($value, 840,1); // DV_Pagadora_Subsidio ?>" class="form-control" style="width: 100px">
                                        <td> <input type="text" name="ccosots_suc_agencia_obra_region[]" value="<?php echo substr($value, 842,20); // Centro de Costos, Sucursal, Agencia, Obra, Región ?>" class="form-control" style="width: 100px">
                        ...
                        <div class="box-footer">
                            <a class="btn btn-primary btn-lg btn_new_revisor" style="margin-top: 20px;" href="#"> <i class="fa fa-chevron-left"></i> &nbsp; Crear Nueva Revisión </a>
                            <button type="submit" class="btn btn-success btn-lg pull-right" style="margin-top: 20px;"> Generar Archivo &nbsp; <i class="fa fa-floppy-o"></i> </button>
                        </div>
                    </div>
                </form>
                <?php else: ?>
...
$(document).ready(function(){
    ...
    $(document).on('focus','#table-previred input', function(event){
        my_tr = $(this).closest('tr');
        tr_rut = my_tr.data('rut');
        $("table tr").removeClass('focused');
        $("[data-rut='"+tr_rut+"']") .addClass('focused');
    });

    $(document).on('blur','#table-previred input', function(event){
        event.preventDefault();
        my_tr = $(this).closest('tr');
        tr_linea = my_tr.data('linea');

        data_param = "";
        my_tr.find('input').each(function(index, el) {
            input_name = $(this).attr('name');
            var input_name = input_name.replace("[]", "");
            data_param += input_name + "=" + $(this).val() + "&";
        });

        $.ajax({
            type: "POST",
            url: "<?php echo BASE_URL . '/controllers/ajax/' . $entity . '.ajax.php'?>",
            data: "action=save_row&linea=" + tr_linea + "&" + data_param,
            dataType: 'json',
            beforeSend: function(){
                $(".overlayer").show();
            },
    ...
    $(".btn_new_revisor").click(function(event){
        event.preventDefault();
        $.ajax({
            type: "POST",
            url: "<?php echo BASE_URL . '/controllers/ajax/' . $entity . '.ajax.php'?>",
            data: "action=create_new_revisor",
            dataType: 'json',
            beforeSend: function(){
                $(".overlayer").show();
            },
            success: function (json) {
                if( json.status == "OK" ){
                    window.location.href = '<?php echo BASE_URL . '/previred/revisor'; ?>';
                }
            }
        }) 
    })
