...
<div class="content-wrapper">
    <section class="content-header">
        <h1> Listar Rentas no gravadas </h1>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Rentas no gravadas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="tabla_horario" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach( $rentas as $reg ){ ?>
                        <tr>
                            <td> <?php echo $reg['id']?> </td>
                            <td> <?php echo getNombreTrabajador($reg['id_trabajador']) ?> </td>
                            <td> <?php echo $reg['ano']?> </td>
                            <td> <?php echo getNombreMes($reg['mes']) ?> </td>
                            <td> $ <?php echo number_format($reg['valor'],0,',','.') ?> </td>
                            <td>                                      
        ...
        <i class="fa fa-plus-circle"></i> Nueva renta no gravadas
        </a>
        <!-- Large modal -->                                                
