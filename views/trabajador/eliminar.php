        ...
        <section class="content">        
             <div class="box">
                <div class="callout callout-warning">                    
                    ...
                    Trabajador: <strong><?php echo $trabajador['nombres'] ?> <?php echo $trabajador['apellidoPaterno'] ?> <?php echo $trabajador['apellidoMaterno'] ?></strong>
                </div>
              </div><!-- /.box -->
              <form method="post">
                <input type="hidden" name="action" value="delete" />
                <input type="hidden" name="trabajdor_id" value="<?php echo $parametros[1] ?>" />                
