      ...
      <div class="content-wrapper">
        ...
        <div class="overlayer" style="display: block;"><i class="fa fa-refresh fa-spin"></i></div>
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_5" onclick="javascript: return void(0);" data-toggle="tab">Ausencias, Atrasos, H. Extras</a></li>              
            </ul>
                                                            ...
                                                            <table class="table table-bordered" style="background: #fff;" id="table_reloj_control">
                                                            	<tbody>
                                                                    ...
                                                                    for($i=$fechaInicio; $i<=$fechaFin; $i+=86400){
                                                                        ...
                                                                        $fecha_procesada = procesarFecha( $fecha_iterar, $trabajador['relojcontrol_id'], $dias_laborales_horario );
                                                                        $es_ausencia = comprobarAusencia($fecha_iterar, $trabajador['id']);
                                                                                                                                                
                                                                        if( $fecha_procesada['dia_laboral'] == 1 ){
                                                                            if( $es_ausencia['es_ausencia'] == 1 ){
                                                                            ?>
                                                                                <tr>
                                                                                    <td class="ausente"><?php echo translateDia( date('D', strtotime($fecha_iterar)) ) . ": " . $fecha_iterar; ?></td>
                                                                                    <td colspan="4" class="ausente" style="text-align: left;"> <strong><?php echo $es_ausencia['motivo']; ?></strong> </td>
                                                                                </tr>
                                                                                
                                                                            <?php
                                                                            } elseif( $fecha_procesada['es_ausencia'] == 1 ){
                                                                            ?>
                                                                                <tr>
                                                                                    <td class="ausente"><?php echo translateDia( date('D', strtotime($fecha_iterar)) ) . ": " . $fecha_iterar; ?></td>
                                                                                    <td colspan="4" class="ausente"><strong>Ausencia por no marcar</strong> </td>
                                                                                </tr>
                                                                                
                                                                            <?php 
                                                                            } else {
                                                                                if( $fecha_procesada['entrada'] == '' ){ $class = ' ausente '; }                                                                                
                                                                            ?>
                                                                                                                                                
                                                                                <tr>
                                                                                    <td> <?php echo translateDia( date('D', strtotime($fecha_iterar)) ) . ": " . $fecha_iterar; ?> </td>
                                                                                    <td class="<?php echo ( $fecha_procesada['entrada'] == '' ) ? ' ausente ' : ''; ?>">  
                                                                                        <?php 
                                                                                        if( $fecha_procesada['entrada'] == '' ){                                                                                    
                                                                                            echo ' <strong>NO MARCÓ</strong> '; 
                                                                                        } else {
                                                                                            $hora_entrada = strtotime( $fecha_procesada['entrada'] );
                                                                                            ...
                                                                                            //show_array( $fecha_procesada,0 );
                                                                                            echo '<span class="badge ' . $cls . '">' . $fecha_procesada['entrada'] . '</span>';
                                                                                        }
                                                                                        ?>
                                                                                    </td>
                                                                        			<td> 
                                                                                    ...
                                                                                    <td class="<?php echo ( $fecha_procesada['salida'] == '' ) ? ' ausente ' : ''; ?>">  
                                                                                        <?php 
                                                                                        if( $fecha_procesada['salida'] == '' ){                                                                                    
                                                                                            echo ' <strong>NO MARCÓ</strong> '; 
                                                                                        } else {
                                                                                            $hora_salida = strtotime( $fecha_procesada['salida'] );
                                                                                            ...
                                                                                            echo '<span class="badge ' . $cls . '">' . $fecha_procesada['salida'] . '</span>';
                                                                                        }
                                                                                        ?>
                                                                                    </td>
                                                                        			<td> 
                                                                            ...
                                                                            ?>                                                                            
                                                                                <tr>
                                                                                    ...
                                                                                    <td colspan="4" class="no_laboral"></td>
                                                                                </tr>
