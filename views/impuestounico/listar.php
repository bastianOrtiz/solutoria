        ...
        <section class="content">                
             <div class="box">
                <div class="box-header">
                  ...
                  <h4 style="font-size: 12px;">(Valores expresados en utm)</h4>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="tabla_impuestounico" class="table table-bordered table-striped table-responsive">
                    <thead>
                      <tr>
                        <th> ID </th>
                        <th>Desde</th>                        
                    ...
                    <tbody>
                        <?php foreach( $registros as $reg ){ ?>
                            <tr>
                                ...
                                <td> <?php echo $reg['desde']?> </td>
                                 <td> <?php echo $reg['hasta']?> </td>
                                 <td> <?php echo $reg['factor']?> </td>
                                 <td> <?php echo $reg['rebajar']?> </td>
