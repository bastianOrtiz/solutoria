                      ...
                      <div class="box-body">
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="form-group">
                              <label for="cajaDescuento">¿Es un Seguro?</label>
                              <div class="radio">
                                <label>
                                  <input class="rbtDescuentoSeguro" type="radio" name="seguroDescuento[]" value="1" id="seguroDescuentoSi" />
                                  SI
                                </label>
                                 &nbsp; &nbsp; &nbsp; 
                                <label>
                                  <input class="rbtDescuentoSeguro" type="radio" name="seguroDescuento[]" value="0" id="seguroDescuentoNo" checked="checked" />
                                  NO
                                </label>

                                <script> $(".rbtDescuentoSeguro[value=<?php echo $descuento['es_seguro'] ?>]").attr('checked','checked') </script>
                              </div> 
                            </div>
