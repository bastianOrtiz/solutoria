        ...
        <section class="content">                
             <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="tabla_descuento" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th> ID </th>
                        <th>Nombre</th>                        
                    ...
                    <tbody>
                        <?php foreach( $registros as $reg ){ ?>
                            <tr>
                                ...
                                <td> <?php echo booleano($reg['fijo']) ?> </td>
                                ...
                                <td> <?php echo booleano($reg['es_seguro']) ?> </td>
                                <td>                                      
