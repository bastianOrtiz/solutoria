                ...
                <div class="box-body">
                    <table class="table table-bordered" id="tabla_liquidacion">
                        <tbody>
                            ...
                            // EXCEPCIONES
                            if( getAnoMostrarCorte() == 2022 && getMesMostrarCorte() == 4 && $trabajador_id == 60){
                                $topeAfc = 1709430;
                            }
                            ...
                            if( $apv_trabajador ){
                                ...
                                if( $apv['tipo'] == 'A' ){
                                    ...
                                    ?>
                                    <tr>
                                        <td> <strong><?php echo $apv['nombre']; ?></strong> (Tipo <?php echo $apv['tipo'] ?>) </td>
                                        <td class="total"> $ <?php echo number_format($apv['monto'],0,',','.') ?> </td>
                                    </tr>
                                    <?php
                                }
                            } else {
