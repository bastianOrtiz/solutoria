                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" value="" id="nombreContrato" name="nombreContrato" placeholder="Nombre Contrato" />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control required" style="height: 107px;" id="descripcionContrato" name="descripcionContrato"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
