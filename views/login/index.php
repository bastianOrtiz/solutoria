  ...
  <body class="login-page">
      ...
      <div class="login-box-body" style="padding-bottom: 30px;">
        ...
        <form method="post" id="frmLogin">
          ...
          <div class="form-group has-feedback login_email">
            <input name="login_email" type="email" class="form-control required" placeholder="Login"/>
        ...
        <a href="<?php echo BASE_URL ?>/login_trabajador" class="pull-right">(Soy Trabajador)</a>
    ...
    $(document).ready(function(){
        ...
        $(".forgot_pass").click(function(){            
            ...
            $(".login-box-msg").removeClass('error').text('Ingrese su email para enviar instrucciones para reestablecer su contraseña');
            $(this).remove();
        })
    })
