  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <p> &nbsp; </p>
              <a href="<?php echo BASE_URL ?>/login" class="btn btn-primary btn-block btn-flat">Ingresar</a>
            </div><!-- /.col -->
          </div>                                        
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
    ...
    $(document).ready(function(){
        ...
        $(".forgot_pass").click(function(){
            $("#frmLogin").hide();
            $(".login-box-msg").removeClass('error').text('Ingrese su email');
            $("#frmReqPass").fadeIn('fast');        
        })
    })
