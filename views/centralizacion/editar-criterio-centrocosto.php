...
<div class="content-wrapper">
    <section class="content-header">
        <h1> Editar Criterio por Centro Costo </h1>
        <?php include ROOT . '/views/comun/breadcrumbs.php';  ?>
        <?php include ROOT . '/views/comun/alertas.php';  ?>
    </section>
    <section class="content">
        <form role="form" id="frmCrear" method="post">
            <input type="hidden" name="action" value="edit_criterio_centrocosto" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input value="<?php echo $criterio['criterio'] ?>" type="text" class="form-control required" name="nombreCriterio" placeholder="Nombre Criterio" required />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <script>$("[name=centroCosto]").val('<?php echo $criterio['id_ccosto'] ?>');</script>
                            </div>
                        </div>
                    </div>
