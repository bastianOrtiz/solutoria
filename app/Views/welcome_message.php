                    ...
                    <div class="row">
                        <form method="get" action="#">
                            <div class="col-3">
                                ...
                                <select id="cboTipUnidad" name="tipo" class="form-control">
                            ...
                            <div class="col-3">
                                ...
                                <label>Rango de Fechas:</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nomRangoFecha" class="form-control float-right" id="rangofecha" value="">
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Valor Seleccionado <?php echo $nombreUnidad ?></h6>
